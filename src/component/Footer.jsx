                ...
                <div className="max-w-5xl mx-auto px-4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 mb-10">
                    <div className="flex items-center gap-4">
                        <div className="w-12 h-12 rounded-full bg-blue-600/10 flex items-center justify-center shrink-0">
                            <img className="w-6 h-6 object-contain text-blue-500" src="/van.svg" alt="Icon Van Ekspedisi" />
                        </div>
                        <div>
                    ...
                    <div className="flex items-center gap-4">
                        <div className="w-12 h-12 rounded-full bg-blue-600/10 flex items-center justify-center shrink-0">
                            <img className="w-6 h-6 object-contain text-blue-500" src="/shield.svg" alt="Icon shield" />
                        </div>
                        <div>
                    ...
                    <div className="flex items-center gap-4">
                        <div className="w-12 h-12 rounded-full bg-blue-600/10 flex items-center justify-center shrink-0">
                            <img className="w-6 h-6 object-contain text-blue-500" src="/refresh-ccw.svg" alt="Icon Return" />
                        </div>
                        <div>
                    ...
                    <div className="flex items-center gap-4">
                        <div className="w-12 h-12 rounded-full bg-blue-600/10 flex items-center justify-center shrink-0">
                            <img className="w-6 h-6 object-contain text-blue-500" src="/headset.svg" alt="Icon Call Center" />
                        </div>
                        <div>
                ...
                <div className="max-w-5xl mx-auto px-4 grid grid-cols-1 md:grid-cols-12 gap-8 mb-10">
                    ...
                    <div className="md:col-span-4 flex flex-col gap-3">
                        ...
                        <div className="flex items-start gap-2.5 text-xs">
                            <img className="w-4 h-4 object-contain mt-0.5 shrink-0" src="/map-icon.png" alt="Icon Map" />
                                <p className="m-0 leading-relaxed">Jl. Sudirman No. 1, Jakarta Selatan, DKI Jakarta 12190</p>
                        </div>
                        <div className="flex items-center gap-2.5 text-xs">
                            <img className="w-4 h-4 object-contain shrink-0" src="/phone.svg" alt="Icon Phone" />
                                <p className="m-0">0800-1234-5678 (Gratis)</p>
                        </div>
                        <div className="flex items-center gap-2.5 text-xs mb-3">
                            <img className="w-4 h-4 object-contain shrink-0" src="/mail.svg" alt="Icon Mail" />
